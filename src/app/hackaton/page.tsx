...
export const metadata: Metadata = {
  title: "Hackaton 2026 | Caltech Longevity Club",
  description:
    "A one-day, in-person hackaton at Caltech focused on building practical tools and prototypes for longevity research and healthy aging.",
};
...
const JUDGING: { title: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      "Novelty / creativity",
      "Potential to continue post-hackaton",
    ],
  },
  {
    title: "Deliverables",
                    ...
                    <div className="relative w-full overflow-hidden rounded-xl border border-white/10 bg-black/10">
                      <div className="relative aspect-[16/9]">
                        <Image
                          ...
                          alt="Caltech Longevity Innovation Hackaton"
                          fill
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-3 text-muted-foreground">
                      The Caltech Longevity Innovation Hackaton is a hands-on day to build prototypes that
